...
ResultSet rs=st.executeQuery("select * from adminup where username='"+username+"' and password='"+password+"'");
if(rs.next())
{
...
else
{
	...
	out.println("<a href='adminlogin.html'>goto Admin login page</a>");
